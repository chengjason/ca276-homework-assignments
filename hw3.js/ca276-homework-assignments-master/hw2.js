...
//Write my name 
console.log('Jason Cheng');
//Write today's date
console.log('October 3, 2013');
...
var myEmailAdd = 'jcheng19@montgomerycollege.edu';
...
var superManFly = true, superManCannotFly = false;
...
var b = '<a href="#">Some link</a>';
var c = 'JavaScript is "easy" if you are good at it';
console.log(a);
console.log(b);
console.log(c);
...
var jsTopics = ["Types", "Variables", "Functions", "Objects", "Arrays", "Classes", "Expressions", "Modules"];
